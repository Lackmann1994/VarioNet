...
--
-- Current Database: `varionet`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `varionet` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `client_path` (
  ...
  PRIMARY KEY (`id`),
  KEY `client_path_client_idx` (`client_id`),
  CONSTRAINT `client_path_client` FOREIGN KEY (`client_id`) REFERENCES `client` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `client_path` VALUES (1,1,'/1/'),(6,2,'/1/2/'),(7,3,'/1/3/'),(8,4,'/1/2/4/'),(9,5,'/1/5/'),(10,6,'/1/6/'),(11,7,'/1/7/'),(12,8,'/1/8/'),(13,9,'/1/9/'),(14,10,'/1/10/'),(15,11,'/1/11/'),(16,12,'/1/12/'),(17,13,'/1/13/'),(18,14,'/1/14/'),(19,15,'/1/15/');
...
CREATE TABLE `component` (
  ...
  `type` varchar(45) NOT NULL COMMENT 'pos=002,  input type="text", required',
  `name` varchar(45) NOT NULL COMMENT 'pos=001,  input type="text", required',
  `number` int(11) unsigned NOT NULL DEFAULT '1' COMMENT 'pos=003,  input type="number", required',
  PRIMARY KEY (`id`),
  KEY `fk_system_idx` (`system_id`),
  CONSTRAINT `component_system` FOREIGN KEY (`system_id`) REFERENCES `system` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `component` VALUES (1,1,'type1','generic_comp1',3),(2,1,'type1','generic_comp2',2),(3,1,'type2','generic_art1',5),(5,1,'type2','generic_art2',3);
...
CREATE TABLE `data_type` (
  ...
  `data_name2` varchar(65) DEFAULT NULL,
  `config_group` varchar(45) DEFAULT NULL,
  `data_section` varchar(45) DEFAULT NULL,
  `permission` varchar(45) DEFAULT NULL,
  `data_type` varchar(45) DEFAULT NULL,
  `data_name_de` varchar(45) DEFAULT NULL,
  `data_name_en` varchar(45) DEFAULT NULL,
  `data_name_fr` varchar(45) DEFAULT NULL,
  `data_tooltip_de` varchar(45) DEFAULT NULL,
  `data_tooltip_en` varchar(45) DEFAULT NULL,
  `data_tooltip_fr` varchar(45) DEFAULT NULL,
  `data_coefficient` double DEFAULT NULL,
  `data_min_val` int(11) DEFAULT NULL,
  `data_max_val` int(11) DEFAULT NULL,
  `data_unit` varchar(4) DEFAULT NULL,
  `array_type` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `data_type` VALUES (1,'C_Building_Name','K_Anlagen_Name','Grundeinstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'C_Customer_Name','K_Kunden_Name','Grundeinstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,'C_Outside_Sensor_PCB','K_Aussen_Temperatur_Fuehler_Modul','Aussenf√ºhler','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,'C_Outside_Sensor_Channel','K_Aussen_Temperatur_Fuehler_Kanal','Aussenf√ºhler','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,'C_Outside_Sensor_Offset','K_Aussen_Temperatur_Fuehler_Abgleich','Aussenf√ºhler','Anlage_Allgemein_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'¬∞C',NULL),(6,NULL,'K_Aussen_Modbus_Adresse',NULL,'Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,'C_Outside_Humidity_On_Off','K_Aussen_Feuchte_Fuehler_Ein_Aus','Aussenfeuchtesensor','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(8,'C_Outside_Humidity_PCB','K_Aussen_Feuchte_Fuehler_Modul','Aussenfeuchtesensor','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(9,'C_Outside_Humidity_Channel','K_Aussen_Feuchte_Fuehler_Kanal','Aussenfeuchtesensor','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(10,'C_Outside_Humidity_Offset','K_Aussen_Feuchte_Fuehler_Abgleich','Aussenfeuchtesensor','Anlage_Allgemein_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'%',NULL),(11,'C_Outside_Wind_Dir_On_Off','K_Aussen_Windrichtung_Ein_Aus','K_Aussen_Wind','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(12,'C_Outside_Wind_Dir_PCB','K_Aussen_Windrichtung_Modul','K_Aussen_Wind','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(13,'C_Outside_Wind_Dir_Channel','K_Aussen_Windrichtung_Kanal','K_Aussen_Wind','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(14,'C_Outside_Wind_Dir_Resistance','K_Aussen_Windrichtung_Widerstand','K_Aussen_Wind','Anlage_Allgemein_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(15,'C_Outside_Wind_Spd_PCB','K_Aussen_Windgeschwindigkeit_Modul','K_Aussen_Wind','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(16,'C_Outside_Wind_Spd_Channel','K_Aussen_Windgeschwindigkeit_Kanal','K_Aussen_Wind','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(17,'C_Alarm_PCB','K_Alarm_Ausgang_Modul','Alarmeinstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(18,'C_Alarm_Channel','K_Alarm_Ausgang_Kanal','Alarmeinstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(19,'C_Alarm_Inactiv_Status','K_Alarm_Ausgang_Ruhezustand','Alarmeinstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(20,'C_Alarm_Delay','K_Alarm_Ausgang_Zeitverzoegerung','Alarmeinstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'s',NULL),(21,'C_Pump_PCB','K_Pumpen_Ausgang_Modul','Pumpeneinstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(22,'C_Pump_Channel','K_Pumpen_Ausgang_Kanal','Pumpeneinstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(23,'C_Pump_Inactiv_Status','K_Pumpen_Ausgang_Ruhezustand','Pumpeneinstellungen','Anlage_Allgemein_Konfig_Daten','NULL','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(24,'C_Language','K_Sprache',NULL,'Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(25,'C_Ethernet_IP','K_Ethernet_IP_Adresse','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(26,'C_Ethernet_Gateway','K_Ethernet_IP_Gateway','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(27,'C_Ethernet_Subnet','K_Ethernet_Subnetmask','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(28,NULL,'K_Ethernet_IP_Adresse_str','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(29,NULL,'K_Ethernet_IP_Adresse1','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(30,NULL,'K_Ethernet_IP_Adresse2','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(31,NULL,'K_Ethernet_IP_Adresse3','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(32,NULL,'K_Ethernet_IP_Adresse4','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(33,NULL,'K_Ethernet_IP_Gateway_str','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(34,NULL,'K_Ethernet_IP_Gateway1','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(35,NULL,'K_Ethernet_IP_Gateway2','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(36,NULL,'K_Ethernet_IP_Gateway3','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(37,NULL,'K_Ethernet_IP_Gateway4','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(38,NULL,'K_Ethernet_Subnetmask_str','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(39,NULL,'K_Ethernet_Subnetmask1','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(40,NULL,'K_Ethernet_Subnetmask2','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(41,NULL,'K_Ethernet_Subnetmask3','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(42,NULL,'K_Ethernet_Subnetmask4','LAN Daten','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(43,'C_R_Control_Phone_No','K_ISDN_Eigene_Rufnummer','ISDN Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(44,'C_R_Control_User','K_ISDN_Benutzername','ISDN Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(45,'C_R_Control_Password','K_ISDN_Kennwort','ISDN Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(46,'C_R_Control_Encryption','K_ISDN_Kennwort_verschluesselt','ISDN Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(47,'C_R_Control_Local_IP','K_ISDN_LOCAL_IP','ISDN Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(48,'C_R_Control_Remote_IP','K_ISDN_REMOTE_IP','ISDN Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(49,'C_Email_SMTP_User','K_Email_SMTP_User','Email Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(50,'C_Email_SMTP_Password','K_Email_SMTP_Kennwort','Email Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(51,'C_Email_SMTP_Phone_No','K_Email_SMTP_Rufnummer','Email Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(52,'C_Email_SMTP_IP','K_Email_SMTP_IP','Email Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(53,'C_Email_Own','K_Email_Adresse_Von','Email Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(54,'C_Email_On_Off','K_Email_Adresse_Ein_Aus','Email Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,'EMAIL_ADRESSEN_ANZAHL'),(55,'C_Email_To','K_Email_Adresse_An','Email Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'EMAIL_ADRESSEN_ANZAHL'),(56,'C_Email_Head','K_Email_Betreff','Email Einstellungen','Anlage_Allgemein_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'EMAIL_ADRESSEN_ANZAHL'),(57,NULL,'PID_Regler_P',NULL,'Anlage_Allgemein_Konfig_Daten',NULL,'double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(58,NULL,'PID_Regler_I',NULL,'Anlage_Allgemein_Konfig_Daten',NULL,'double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(59,NULL,'PID_Regler_D',NULL,'Anlage_Allgemein_Konfig_Daten',NULL,'double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(60,NULL,'A_LMS_Absenkung_ab',NULL,'Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(61,NULL,'A_LMS_Absenkung_bis',NULL,'Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(62,'C_Password_Inst','K_Passwort_Install',NULL,'Anlage_Allgemein_Konfig_Daten',NULL,'signed int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(63,'C_Password_Cust','K_Passwort_Eingabe',NULL,'Anlage_Allgemein_Konfig_Daten',NULL,'signed int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(64,'C_Password_Inst_On_Off','K_Passwort_Install_aktiv',NULL,'Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(65,'C_Password_Cust_On_Off','K_Passwort_Eingabe_aktiv',NULL,'Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(66,NULL,'K_Passwort_Ziel_Maske',NULL,'Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(67,NULL,'K_Wasser_E_A','K_Wasser','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,'WASSERZAEHLER_ANZAHL'),(68,NULL,'K_Wasser_Modul','K_Wasser','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WASSERZAEHLER_ANZAHL'),(69,NULL,'K_Wasser_Kanal','K_Wasser','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WASSERZAEHLER_ANZAHL'),(70,NULL,'K_Wasser_Normierung','K_Wasser','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WASSERZAEHLER_ANZAHL'),(71,NULL,'K_Wasser_Tag','K_Wasser','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WASSERZAEHLER_ANZAHL:WASSER_TAGE'),(72,NULL,'K_Wasser_Woche','K_Wasser','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WASSERZAEHLER_ANZAHL'),(73,NULL,'K_Wasser_4_Wochen','K_Wasser','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WASSERZAEHLER_ANZAHL'),(74,NULL,'K_Wasser_12_Monat','K_Wasser','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WASSERZAEHLER_ANZAHL'),(75,NULL,'K_Wasser_Abweichung_Vor_Tag','K_Wasser','Anlage_Allgemein_Konfig_Daten',NULL,'signed int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WASSERZAEHLER_ANZAHL:WASSER_TAGE'),(76,NULL,'K_Wasser_Alarm_E_A','K_Wasser','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WASSERZAEHLER_ANZAHL'),(77,NULL,'K_Wasser_Alarm_Hysterese','K_Wasser','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WASSERZAEHLER_ANZAHL'),(78,NULL,'K_Wasser_Alarm','K_Wasser','Anlage_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WASSERZAEHLER_ANZAHL'),(79,NULL,'K_Netzwerk_Modus','k_data','Geraet_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(80,NULL,'K_Netzwerk_Anzahl_Node','k_data','Geraet_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(81,NULL,'A_User_Kontrast','missing','Geraet_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(82,NULL,'A_User_Helligkeit','missing','Geraet_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(83,NULL,'K_Ethernet_E_A','k_data','Geraet_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(84,NULL,'K_ISDN_Ein_Aus','k_data','Geraet_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(85,NULL,'K_Spannung_Zu_Hoch','k_data','Geraet_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(86,NULL,'K_Spannung_Zu_Niedrig','k_data','Geraet_Allgemein_Konfig_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(87,NULL,'K_Innentemperatur_Zu_Hoch','k_data','Geraet_Allgemein_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(88,NULL,'K_Innentemperatur_Zu_Niedrig','k_data','Geraet_Allgemein_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(89,NULL,'K_Neustart_Flag','k_data','Geraet_Allgemein_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(90,'V_Room_Mode','A_Stall_Betriebsart','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(91,'V_Temp_Order','A_Temperatur_Sollwert','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(92,'V_Volum_Min','A_Luft_Min','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(93,'V_Volum_Max','A_Luft_Max','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(94,'V_Temp_Scale','A_Regelbereich','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(95,'V_Animal','A_Belegung_Tiere','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(96,'V_Animal_Kilo','A_Belegung_kg','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(97,'V_Animal_0','A_Belegung_Anforderung_0','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(98,'V_Animal_25','A_Belegung_Anforderung_25','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(99,'V_Animal_50','A_Belegung_Anforderung_50','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(100,'V_Animal_75','A_Belegung_Anforderung_75','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(101,'V_Animal_100','A_Belegung_Anforderung_100','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(102,'V_Days','A_Programme_Tag','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PROGRAMM_PUNKTE'),(103,'V_Temp_On_Off','A_Programm_Sollwert_Aktiv','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,'BETRIEBSART_ANZAHL'),(104,'V_Temp_Order_Curve','A_Programm_Sollwert_Wert','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PROGRAMM_PUNKTE'),(105,'V_Volume_On_Off','A_Programm_Min_Max_Aktiv','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,'BETRIEBSART_ANZAHL'),(106,'V_Min_Value','A_Programm_Min_Wert','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PROGRAMM_PUNKTE'),(107,'V_Max_Value','A_Programm_Max_Wert','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PROGRAMM_PUNKTE'),(108,'V_Animal_On_Off','A_Programm_Belegung_Aktiv','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,'BETRIEBSART_ANZAHL'),(109,'V_Animal_Curve','A_Programm_Belegung_Wert','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PROGRAMM_PUNKTE'),(110,NULL,'A_Absenkautomatik_Ein_Aus','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,'BETRIEBSART_ANZAHL'),(111,NULL,'A_Absenkautomatik_ab','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(112,NULL,'A_Absenkautomatik_Zugabe_Vergroesserung','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(113,NULL,'A_Absenkautomatik_RB_Faktor','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(114,NULL,'A_Absenkautomatik_Rueckstellung_in','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(115,NULL,'A_Begrenzungsminderung_Ein_Aus','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,'BETRIEBSART_ANZAHL'),(116,NULL,'A_Begrenzungsminderung_ab','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(117,NULL,'A_Begrenzungsminderung_bis','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(118,NULL,'A_Begrenzungsminderung_Absenkung','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(119,NULL,'A_Feuchtezugabe_ab','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(120,NULL,'A_Feuchtezugabe_bis','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(121,NULL,'A_Feuchtezugabe_max','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(122,NULL,'A_Feuchte_Sollwert','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(123,NULL,'A_Feuchte_Regelbereich','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(124,NULL,'A_Feuchte_Aenderung','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(125,NULL,'A_Schadstoff_Sollwert','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(126,NULL,'A_Schadstoff_Regelbereich','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(127,NULL,'A_Schadstoff_Aenderung','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(128,NULL,'A_Alarm_Ein_Aus','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,'BETRIEBSART_ANZAHL'),(129,NULL,'A_Alarm_Uebertemperatur','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(130,NULL,'A_Alarm_Untertemperatur','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(131,NULL,'A_Alarm_Differenz','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(132,NULL,'A_Heizung_Modus','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(133,NULL,'A_Heizung_Sollwert','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(134,NULL,'A_Heizung_Versatz','missing','Stall_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(135,NULL,'A_Heizung_Hysterese','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(136,NULL,'A_Programm_Heizung_Aktiv','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(137,NULL,'A_Programm_Versatz_Aktiv','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(138,'A_Programm_Versatz_Wert','A_Programm_Versatz_Wert','missing','Stall_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PROGRAMM_PUNKTE'),(139,'V_Analog_Diff','A_Regler_Analog_Versatz','missing','Stall_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL:REGLER_ANZAHL'),(140,'V_Analog_Scale','A_Regler_Analog_Regelbereich','missing','Stall_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL:REGLER_ANZAHL'),(141,'V_Analog_Air_Min','A_Regler_Analog_oeffnen_ab','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL:REGLER_ANZAHL'),(142,'V_Analog_Air_Max','A_Regler_Analog_oeffnen_bis','missing','Stall_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL:REGLER_ANZAHL'),(143,'V_Analog_Min','A_Regler_Analog_Minimalwert','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL:REGLER_ANZAHL'),(144,'V_Analog_Max','A_Regler_Analog_Maximalwert','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL:REGLER_ANZAHL'),(145,NULL,'A_Tagesverlauf_Start_Stunden','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(146,NULL,'A_Tagesverlauf_Start_Minuten','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(147,NULL,'A_Tagesverlauf_Amplitude_Pos','missing','Stall_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(148,NULL,'A_Tagesverlauf_Amplitude_Neg','missing','Stall_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(149,NULL,'A_Tagesverlauf_E_A','missing','Stall_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(150,'C_Room_On_Off','K_Stall_Ein_Aus','Grundeinstellungen','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(151,NULL,'K_Stall_Bezeichnung','Grundeinstellungen','Stall_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(152,NULL,'K_Stall_Name','Grundeinstellungen','Stall_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(153,'C_Mode_Name','K_Stall_Betriebsart_Name','Grundeinstellungen','Stall_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(154,'C_Mode_Bmp','K_Stall_Betriebsart_Bmp','Grundeinstellungen','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'BETRIEBSART_ANZAHL'),(155,'C_Room_Sensor_PCB','K_Temperatur_Fuehler_Modul','Raumf√ºhler','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(156,'C_Room_Sensor_Channel','K_Temperatur_Fuehler_Kanal','Raumf√ºhler','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(157,'C_Room_Sensor_Offset','K_Temperatur_Fuehler_Abgleich','Raumf√ºhler','Stall_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(158,'C_Room_Alarm_Low','K_Untertemperatur_Alarm_Ein_Aus','Raumf√ºhler','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(159,'C_Room_Vent_On_Off','K_Lueftung_Ein_Aus','Luftleistung','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(160,'C_Room_Vent_PCB','K_Lueftung_Analogausgang_Modul','Luftleistung','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(161,'C_Room_Vent_Channel','K_Lueftung_Analogausgang_Kanal','Luftleistung','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(162,'C_Room_Vent_Min_V','K_Lueftung_Analogausgang_Min_V','Luftleistung','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(163,'C_Room_Vent_Max_V','K_Lueftung_Analogausgang_Max_V','Luftleistung','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(164,'C_Room_Animal_Max','K_Belegung_Tiere_Max','Tierdaten','Stall_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(165,'C_Room_Kilo_Max','K_Belegung_kg_Max','Tierdaten','Stall_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(166,'C_Room_Humid_On_Off','K_Feuchte_Ein_Aus','Raumfeuchtesensor','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(167,'C_Room_Humid_PCB','K_Feuchte_Fuehler_Modul','Raumfeuchtesensor','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(168,'C_Room_Humid_Channel','K_Feuchte_Fuehler_Kanal','Raumfeuchtesensor','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(169,'C_Room_Humid_Min_Volt','K_Feuchte_Min_V','Raumfeuchtesensor','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(170,'C_Room_Humid_Max_Volt','K_Feuchte_Max_V','Raumfeuchtesensor','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(171,'C_Room_Humid_Min_Val','K_Feuchte_Min_Wert','Raumfeuchtesensor','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(172,'C_Room_Humid_Max_Val','K_Feuchte_Max_Wert','Raumfeuchtesensor','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(173,NULL,'K_Feuchte_Alarm_Modus','Raumfeuchtesensor','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(174,'C_Room_ASS_On_Off','K_SSensor_Ein_Aus','Luftmengensensor','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(175,'C_Room_ASS_PCB','K_SSensor_Modul','Luftmengensensor','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(176,'C_Room_ASS_Channel_One','K_SSensor_Kanal_1','Luftmengensensor','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(177,'C_Room_ASS_Channel_Two','K_SSensor_Kanal_2','Luftmengensensor','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(178,'C_Room_ASS_100Percent','K_SSensor_100_Prozent','Luftmengensensor','Stall_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(179,'C_Room_ASS_Surface','K_SSensor_Flaeche','Luftmengensensor','Stall_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(180,'C_Room_Air_Q_Name','K_Schadstoff_Name','Luftqualit√§t','Stall_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(181,'C_Room_Air_Q_On_Off','K_Schadstoff_Ein_Aus','Luftqualit√§t','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(182,'C_Room_Air_Q_PCB','K_Schadstoff_Fuehler_Modul','Luftqualit√§t','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(183,'C_Room_Air_Q_Channel','K_Schadstoff_Fuehler_Kanal','Luftqualit√§t','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(184,'C_Room_Air_Q_Min_Volt','K_Schadstoff_Min_V','Luftqualit√§t','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(185,'C_Room_Air_Q_Max_Volt','K_Schadstoff_Max_V','Luftqualit√§t','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(186,'C_Room_Air_Q_Min_Val','K_Schadstoff_Min_Wert','Luftqualit√§t','Stall_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(187,'C_Room_Air_Q_Max_Val','K_Schadstoff_Max_Wert','Luftqualit√§t','Stall_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(188,NULL,'K_Schadstoff_Alarm_Modus','Luftqualit√§t','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(189,'C_Room_Heat_Mode','K_Heizung_Ein_Aus','Heizungseinstellungen','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(190,'C_Room_Heat_PCB','K_Heizung_Ausgang_Modul','Heizungseinstellungen','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(191,'C_Room_Heat_Channel','K_Heizung_Ausgang_Kanal','Heizungseinstellungen','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(192,'C_Room_Heat_inactiv_status','K_Heizung_Ausgang_Ruhezustand','Heizungseinstellungen','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(193,'C_Room_Analog_On_Off','K_Regler_Analog_Ein_Aus','Analogeinstellungen','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,'REGLER_ANZAHL'),(194,'C_Room_Analog_Temp_Air','K_Regler_Analog_Temp_Luft','Analogeinstellungen','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'REGLER_ANZAHL'),(195,'C_Room_Analog_Name','K_Regler_Analog_Name','Analogeinstellungen','Stall_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'REGLER_ANZAHL'),(196,'C_Room_Analog_PCB','K_Regler_Analog_Analogausgang_Modul','Analogeinstellungen','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'REGLER_ANZAHL'),(197,'C_Room_Analog_Channel','K_Regler_Analog_Analogausgang_Kanal','Analogeinstellungen','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'REGLER_ANZAHL'),(198,'C_Room_Analog_Min_V','K_Regler_Analog_Analogausgang_Min_V','Analogeinstellungen','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'REGLER_ANZAHL'),(199,'C_Room_Analog_Max_V','K_Regler_Analog_Analogausgang_Max_V','Analogeinstellungen','Stall_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'REGLER_ANZAHL'),(200,'C_Fan1_On_Off','K_Luefter_Ein_Aus','Grundeinstellungen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(201,'C_Fan1_Name','K_Luefter_Name','Grundeinstellungen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(202,'C_Fan1_Triac_PCB','K_Luefter_Triac_Modul','Triaceinstellungen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(203,'C_Fan1_Triac_Channel','K_Luefter_Triac_Kanal','Triaceinstellungen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(204,'C_Fan1_Analog_PCB','K_Luefter_Analogausgang_Modul','Einstellungen Analogausgang','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(205,'C_Fan1_Analog_Channel','K_Luefter_Analogausgang_Kanal','Einstellungen Analogausgang','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(206,'C_Fan1_Analog_Min_Volt','K_Luefter_Analogausgang_Min_V','Einstellungen Analogausgang','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(207,'C_Fan1_Analog_Max_Volt','K_Luefter_Analogausgang_Max_V','Einstellungen Analogausgang','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(208,'C_Fan1_Hysteresis','K_Luefter_Hysterese','Triaceinstellungen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(209,'C_Fan1_Start_Speed','K_Anlauf_Drehzahl','Triaceinstellungen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(210,'C_Fan1_Start_Time','K_Anlauf_Zeit','Triaceinstellungen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(211,NULL,'A_Luefter_Pause',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(212,NULL,'K_Stufe1_Alarm_In_Modul','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(213,NULL,'K_Stufe1_Alarm_In_Kanal','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(214,NULL,'A_Stufe1_Drehzahl_Min',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(215,NULL,'A_Stufe1_Drehzahl_Max',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(216,NULL,'K_Stufe2_Installiert','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(217,NULL,'K_Stufe2_Alarm_In_Modul','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(218,NULL,'K_Stufe2_Alarm_In_Kanal','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(219,NULL,'A_Stufe2_Anlauf',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(220,NULL,'A_Stufe2_Absenkung',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(221,NULL,'A_Stufe2_Drehzahl_Max',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(222,NULL,'A_Stufe2_Blockierschutz_Stunden',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(223,NULL,'A_Stufe2_Blockierschutz_Minuten',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(224,NULL,'A_Stufe2_Blockierschutz_Dauer',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(225,NULL,'A_Stufe2_Blockierschutz_Drehzahl',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(226,NULL,'K_Stufe2_Ausgang_Modul','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(227,NULL,'K_Stufe2_Ausgang_Kanal','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(228,NULL,'K_Stufe2_Ausgang_Ruhezustand','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(229,NULL,'K_Stufe2_Stellmotor','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(230,NULL,'K_Stufe2_Stellmotor_Ruhezustand','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(231,NULL,'K_Stufe2_mit_ohne_Relais_Stellmotor','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(232,NULL,'K_Stufe3_Installiert','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(233,NULL,'K_Stufe3_Alarm_In_Modul','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(234,NULL,'K_Stufe3_Alarm_In_Kanal','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(235,NULL,'A_Stufe3_Anlauf',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(236,NULL,'A_Stufe3_Absenkung',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(237,NULL,'A_Stufe3_Drehzahl_Max',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(238,NULL,'A_Stufe3_Blockierschutz_Stunden',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(239,NULL,'A_Stufe3_Blockierschutz_Minuten',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(240,NULL,'A_Stufe3_Blockierschutz_Dauer',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(241,NULL,'A_Stufe3_Blockierschutz_Drehzahl',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(242,NULL,'K_Stufe3_Ausgang_Modul','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(243,NULL,'K_Stufe3_Ausgang_Kanal','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(244,NULL,'K_Stufe3_Ausgang_Ruhezustand','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(245,NULL,'K_Stufe3_Stellmotor','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(246,NULL,'K_Stufe3_Stellmotor_Ruhezustand','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(247,NULL,'K_Stufe3_mit_ohne_Relais_Stellmotor','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(248,NULL,'K_Stufe4_Installiert','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(249,NULL,'K_Stufe4_Alarm_In_Modul','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(250,NULL,'K_Stufe4_Alarm_In_Kanal','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(251,NULL,'A_Stufe4_Anlauf',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(252,NULL,'A_Stufe4_Absenkung',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(253,NULL,'A_Stufe4_Drehzahl_Max',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(254,NULL,'A_Stufe4_Blockierschutz_Stunden',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(255,NULL,'A_Stufe4_Blockierschutz_Minuten',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(256,NULL,'A_Stufe4_Blockierschutz_Dauer',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(257,NULL,'A_Stufe4_Blockierschutz_Drehzahl',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(258,NULL,'K_Stufe4_Ausgang_Modul','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(259,NULL,'K_Stufe4_Ausgang_Kanal','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(260,NULL,'K_Stufe4_Ausgang_Ruhezustand','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(261,NULL,'K_Stufe4_Stellmotor','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(262,NULL,'K_Stufe4_Stellmotor_Ruhezustand','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(263,NULL,'K_Stufe4_mit_ohne_Relais_Stellmotor','Einstellungen L√ºfterstufen','Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(264,NULL,'K_Bewertung_Verhalten_wie',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(265,NULL,'A_Bewertung',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'STALL_ANZAHL'),(266,NULL,'A_Bewertung_Regler',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'STALL_ANZAHL:REGLER_ANZAHL'),(267,NULL,'A_Optivent_Wert',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(268,'C_Air_Press_PCB','K_Luft_Druck_Fuehler_Modul',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(269,'C_Air_Press_Channel','K_Luft_Druck_Fuehler_Kanal',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(270,'C_Air_Press_Min_Volt','K_Luft_Druck_Min_V',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(271,'C_Air_Press_Max_Volt','K_Luft_Druck_Max_V',NULL,'Lueftergruppe_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(272,'C_Air_Press_Min_Val','K_Luft_Druck_Min_Wert',NULL,'Lueftergruppe_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(273,'C_Air_Press_Max_Val','K_Luft_Druck_Max_Wert',NULL,'Lueftergruppe_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(274,'C_Air_Press_Curve1','K_Luft_Kennlinie0',NULL,'Lueftergruppe_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(275,'C_Air_Press_Curve2','K_Luft_Kennlinie25',NULL,'Lueftergruppe_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(276,'C_Air_Press_Curve3','K_Luft_Kennlinie50',NULL,'Lueftergruppe_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(277,'C_Air_Press_Curve4','K_Luft_Kennlinie75',NULL,'Lueftergruppe_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(278,'C_Air_Press_Curve5','K_Luft_Kennlinie100',NULL,'Lueftergruppe_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(279,'C_Flep_On_Off','K_Tauscher_Ein_Aus','Tauscher','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(280,'C_Flep_Name','K_Tauscher_Name','Tauscher','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(281,'C_Flep_Analog_PCB','K_Tauscher_Analogausgang_Modul','Tauscher','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(282,'C_Flep_Analog_Channel','K_Tauscher_Analogausgang_Kanal','Tauscher','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(283,'C_Flep_Analog_Min_Volt','K_Tauscher_Analogausgang_Min_V','Tauscher','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(284,'C_Flep_Analog_Max_Volt','K_Tauscher_Analogausgang_Max_V','Tauscher','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(285,'V_Position_Min','A_Oeffnung_Min','Klappeneinstellung','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(286,'V_Position_Max','A_Oeffnung_Max','Klappeneinstellung','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(287,'V_Out_Temp_Min','A_Oeffnung_Temperatur_Min','Aussentemperaturabh√§ngige Regelung','Waermetauscher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(288,'V_Out_Temp_Max','A_Oeffnung_Temperatur_Max','Aussentemperaturabh√§ngige Regelung','Waermetauscher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(289,'V_Air_Vol_Min','A_Oeffnung_Luftleistung_Min','Luftleistungsabh√§nige Regelung','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(290,'V_Air_Vol_Max','A_Oeffnung_Luftleistung_Max','Luftleistungsabh√§nige Regelung','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(291,NULL,'K_Bewertung_Verhalten_wie',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(292,NULL,'K_Bewertung_Verhalten_wie_Luft',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(293,NULL,'K_Bewertung_Verhalten_wie_norm',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(294,NULL,'A_Bewertung',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'STALL_ANZAHL'),(295,NULL,'A_Bewertung_Regler',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'STALL_ANZAHL:REGLER_ANZAHL'),(296,'C_Flep_Fan_On_Off','K_Zuluefter_Ein_Aus','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(297,'C_Flep_Fan_Name','K_Zuluefter_Name','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(298,'C_Flep_Fan_Relais_PCB','K_Zuluefter_Ausgang_Modul','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(299,'C_Flep_Fan_Relais_Channel','K_Zuluefter_Ausgang_Kanal','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(300,'C_Flep_Fan_Inactiv_Status','K_Zuluefter_Ausgang_Ruhezustand','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(301,'C_Flep_Fan_Hysteresis','K_Zuluefter_Hysterese','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(302,NULL,'A_Zuluefter_Oeffnung_bis',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(303,'C_Flep_Fan_PS_On_Off','K_Zuluefter_Druck_Ein_Aus','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(304,'C_Flep_Fan_PS_PCB','K_Zuluefter_Druck_Fuehler_Modul','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(305,'C_Flep_Fan_PS_Channel','K_Zuluefter_Druck_Fuehler_Kanal','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(306,'C_Flep_Fan_PS_Min_Volt','K_Zuluefter_Druck_Min_V','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(307,'C_Flep_Fan_PS_Max_Volt','K_Zuluefter_Druck_Max_V','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(308,'C_Flep_Fan_PS_Min_Val','K_Zuluefter_Druck_Min_Wert','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(309,'C_Flep_Fan_PS_Max_Val','K_Zuluefter_Druck_Max_Wert','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(310,'C_Flep_Fan_Triac_PCB','K_Zuluefter_Triac_Modul','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(311,'C_Flep_Fan_Triac_Channel','K_Zuluefter_Triac_Kanal','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(312,'C_Flep_Fan_Analog_PCB','K_Zuluefter_Analogausgang_Modul','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(313,'C_Flep_Fan_Analog_Channel','K_Zuluefter_Analogausgang_Kanal','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(314,'C_Flep_Fan_Analog_Min_Volt','K_Zuluefter_Analogausgang_Min_V','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(315,'C_Flep_Fan_Analog_Max_Volt','K_Zuluefter_Analogausgang_Max_V','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(316,'C_Flep_Fan_PS_From','K_Zuluefter_Druck_von','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(317,'C_Flep_Fan_PS_Till','K_Zuluefter_Druck_bis','Zul√ºfter','Waermetauscher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(318,'C_Flep_Wash_Mode','K_Waschen_Modus','Waschen','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(319,'C_Flep_Wash_Bot_PCB','K_Waschen_Relais_Unten_Modul','Waschen','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(320,'C_Flep_Wash_Bot_Channel','K_Waschen_Relais_Unten_Kanal','Waschen','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(321,'C_Flep_Wash_Bot_Inactiv_Status','K_Waschen_Relais_Unten_Ruhezustand','Waschen','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(322,'C_Flep_Wash_Top_PCB','K_Waschen_Relais_Oben_Modul','Waschen','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(323,'C_Flep_Wash_Top_Channel','K_Waschen_Relais_Oben_Kanal','Waschen','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(324,'C_Flep_Wash_Top_Inactiv_Status','K_Waschen_Relais_Oben_Ruhezustand','Waschen','Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(325,'C_Flep_Wash_Mode','A_Waschen_Modus',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(326,NULL,'A_Waschen_Unten_Hand',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(327,NULL,'A_Waschen_Oben_Hand',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(328,NULL,'A_Waschen_Betriebsstd',NULL,'Waermetauscher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(329,NULL,'A_Waschen_Aussentemp_Betriebsstd',NULL,'Waermetauscher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(330,NULL,'A_Waschen_Dauer_Unten',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(331,NULL,'A_Waschen_Dauer_Oben',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(332,NULL,'A_Waschen_Aussentemp_Frostschutz',NULL,'Waermetauscher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(333,NULL,'A_Waschen_Tag_Ein_Aus',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,'WOCHENTAG_ANZAHL'),(334,NULL,'A_Waschen_Ein_Stunde',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WOCHENTAG_ANZAHL'),(335,'C_Flep_Weather_Mode','K_Wetter_Ein_Aus',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(336,'C_Flep_Pulse_Pause','K_Puls_Pause',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(337,'C_Flep_Pulse_Max','K_Puls_Max',NULL,'Waermetauscher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(338,'C_Flep_Direction','K_Richtung',NULL,'Waermetauscher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(339,NULL,'A_Wind_Wert',NULL,'Waermetauscher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PROGRAMM_PUNKTE'),(340,NULL,'A_WindUndRegen_Wert',NULL,'Waermetauscher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PROGRAMM_PUNKTE'),(341,NULL,'A_AT_Wert',NULL,'Waermetauscher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PROGRAMM_PUNKTE'),(342,NULL,'A_Wind_Aenderung',NULL,'Waermetauscher_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PROGRAMM_PUNKTE'),(343,NULL,'A_WindUndRegen_Aenderung',NULL,'Waermetauscher_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PROGRAMM_PUNKTE'),(344,NULL,'A_AT_Aenderung',NULL,'Waermetauscher_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'PROGRAMM_PUNKTE'),(345,NULL,'A_Sturm_Wert',NULL,'Waermetauscher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(346,'C_Switch_On_Off','K_Schalt_Ausgang_Ein_Aus',NULL,'Schaltausgang_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(347,'C_Switch_Name','K_Schalt_Ausgang_Name',NULL,'Schaltausgang_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(348,'C_Switch_PCB','K_Schalt_Ausgang_Modul',NULL,'Schaltausgang_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(349,'C_Switch_Channel','K_Schalt_Ausgang_Kanal',NULL,'Schaltausgang_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(350,'C_Switch_Inactiv_Status','K_Schalt_Ausgang_Ruhezustand',NULL,'Schaltausgang_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(351,'C_Switch_Sensor_PCB','K_Eingabe_Schalt_Fuehl_Modul',NULL,'Schaltausgang_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(352,'C_Switch_Sensor_Channel','K_Eingabe_Schalt_Fuehl_Kanal',NULL,'Schaltausgang_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(353,'C_Switch_Sensor_Offset','K_Eingabe_Schalt_Fuehl_Abgleich',NULL,'Schaltausgang_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(354,NULL,'K_Schalt_Ausgang_Hysterese',NULL,'Schaltausgang_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(355,'V_Temp_On','A_Eingabe_Schalttemperatur',NULL,'Schaltausgang_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(356,'V_Time_Min_Start','A_Eingabe_Schaltzeit_Minuten_V',NULL,'Schaltausgang_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(357,'V_Time_Min_End','A_Eingabe_Schaltzeit_Minuten_B',NULL,'Schaltausgang_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(358,'V_Time_Hour_Start','A_Eingabe_Schaltzeit_Stunden_V',NULL,'Schaltausgang_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(359,'V_Time_Hour_End','A_Eingabe_Schaltzeit_Stunden_B',NULL,'Schaltausgang_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(360,'V_And_Or','A_Eingabe_Und_Oder',NULL,'Schaltausgang_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(361,'V_erval_On_Off','A_Eingabe_Interval_Ein_Aus',NULL,'Schaltausgang_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(362,'V_erval_Sec_Off','A_Eingabe_Interval_Zeit_Aus',NULL,'Schaltausgang_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(363,'V_erval_Sec_On','A_Eingabe_Interval_Zeit_Ein',NULL,'Schaltausgang_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(364,NULL,'A_Sicherung_Zeit_Ein',NULL,'Schaltausgang_Konfig_Daten',NULL,'long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(365,NULL,'A_Sicherung_Zeit_Aus',NULL,'Schaltausgang_Konfig_Daten',NULL,'long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(366,NULL,'A_Zeit_Ein_gesichert',NULL,'Schaltausgang_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(367,NULL,'A_Zeit_Aus_gesichert',NULL,'Schaltausgang_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(368,NULL,'K_Luftwaescher_Ein_Aus','Grundeinstellungen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(369,'C_Washing1_Name','K_Luftwaescher_Name','Grundeinstellungen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(370,'C_Washing1_On_Off','K_Pumpe_Ein_Aus','Grundeinstellungen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(371,'C_Washing1_Triac_PCB','K_Pumpe_Triac_Modul','Triaceinstellungen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(372,'C_Washing1_Triac_Channel','K_Pumpe_Triac_Kanal','Triaceinstellungen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(373,'C_Washing1_Analog_PCB','K_Pumpe_Analogausgang_Modul','Pumpe Analogausgang','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(374,'C_Washing1_Analog_Channel','K_Pumpe_Analogausgang_Kanal','Pumpe Analogausgang','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(375,'C_Washing1_Analog_Min_Volt','K_Pumpe_Analogausgang_Min_V','Pumpe Analogausgang','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(376,'C_Washing1_Analog_Max_Volt','K_Pumpe_Analogausgang_Max_V','Pumpe Analogausgang','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(377,'C_Washing1_Hyst','K_Pumpe_Hysterese','Triaceinstellungen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(378,'C_Washing1_Start_Speed','K_Anlauf_Drehzahl','Triaceinstellungen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(379,NULL,'K_Anlauf_Zeit','Triaceinstellungen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(380,NULL,'A_Stufe1_Drehzahl_Min',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(381,NULL,'A_Stufe1_Drehzahl_Max',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(382,NULL,'K_Stufe2_Installiert','Einstellungen Pumpenstufen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(383,NULL,'A_Stufe2_Anlauf',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(384,NULL,'A_Stufe2_Absenkung',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(385,NULL,'A_Stufe2_Drehzahl_Max',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(386,NULL,'A_Stufe2_Stand_By_Minuten',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(387,NULL,'A_Stufe2_Stand_By_Dauer',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(388,NULL,'K_Stufe2_Ausgang_Modul','Einstellungen Pumpenstufen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(389,NULL,'K_Stufe2_Ausgang_Kanal','Einstellungen Pumpenstufen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(390,NULL,'K_Stufe2_Ausgang_Ruhezustand','Einstellungen Pumpenstufen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(391,NULL,'K_Stufe3_Installiert','Einstellungen Pumpenstufen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(392,NULL,'A_Stufe3_Anlauf',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(393,NULL,'A_Stufe3_Absenkung',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(394,NULL,'A_Stufe3_Drehzahl_Max',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(395,NULL,'A_Stufe3_Stand_By_Minuten',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(396,NULL,'A_Stufe3_Stand_By_Dauer',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(397,NULL,'K_Stufe3_Ausgang_Modul','Einstellungen Pumpenstufen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(398,NULL,'K_Stufe3_Ausgang_Kanal','Einstellungen Pumpenstufen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(399,NULL,'K_Stufe3_Ausgang_Ruhezustand','Einstellungen Pumpenstufen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(400,NULL,'K_Stufe4_Installiert','Einstellungen Pumpenstufen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(401,NULL,'A_Stufe4_Anlauf',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(402,NULL,'A_Stufe4_Absenkung',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(403,NULL,'A_Stufe4_Drehzahl_Max',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(404,NULL,'A_Stufe4_Stand_By_Minuten',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(405,NULL,'A_Stufe4_Stand_By_Dauer',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(406,NULL,'K_Stufe4_Ausgang_Modul','Einstellungen Pumpenstufen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(407,NULL,'K_Stufe4_Ausgang_Kanal','Einstellungen Pumpenstufen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(408,NULL,'K_Stufe4_Ausgang_Ruhezustand','Einstellungen Pumpenstufen','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(409,'C_Washing_Fan_Group','K_LL_Von_Lueftergruppe',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(410,'C_Mud_On_Off','K_Schlammpumpe_Relais_Ein_Aus','Schlammpumpe','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(411,'C_Mud_Name','K_Schlammpumpe_Relais_Name','Schlammpumpe','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(412,'C_Mud_Relais_PCB','K_Schlammpumpe_Relais_Ausgang_Modul','Schlammpumpe','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(413,'C_Mud_Relais_Channel','K_Schlammpumpe_Relais_Ausgang_Kanal','Schlammpumpe','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(414,'C_Mud_Inactiv_Status','K_Schlammpumpe_Relais_Ausgang_Ruhezustand','Schlammpumpe','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(415,'V_Mud_On_Off','A_Schlammpumpe_Tag_Ein_Aus',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,'WOCHENTAG_ANZAHL'),(416,'V_Mud_Hour','A_Schlammpumpe_Ein_Stunde',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WOCHENTAG_ANZAHL'),(417,'V_Mud_Duration','A_Schlammpumpe_Ein_Dauer',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WOCHENTAG_ANZAHL'),(418,'C_Mud_Sensor_On_Off','K_Schlammpumpe_Sensor_Ein_Aus','Schlammpumpe','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(419,'C_Mud_Sensor_Name','K_Schlammpumpe_Sensor_Name','Schlammpumpe','Luftwaescher_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(420,'C_Mud_Sensor_PCB','K_Schlammpumpe_Sensor_Fuehler_Modul','Schlammpumpe','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(421,'C_Mud_Sensor_Channel','K_Schlammpumpe_Sensor_Fuehler_Kanal','Schlammpumpe','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(422,'C_Mud_Sensor_Min_Volt','K_Schlammpumpe_Sensor_Min_V','Schlammpumpe','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(423,'C_Mud_Sensor_Max_Volt','K_Schlammpumpe_Sensor_Max_V','Schlammpumpe','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(424,'C_Mud_Sensor_Min_Val','K_Schlammpumpe_Sensor_Min_Wert','Schlammpumpe','Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(425,'C_Mud_Sensor_Max_Val','K_Schlammpumpe_Sensor_Max_Wert','Schlammpumpe','Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(426,'V_Mud_Sensor_Order','A_Schlammpumpe_Sensor_Sollwert',NULL,'Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(427,'V_Mud_Sensor_Hyst','A_Schlammpumpe_Ein_Hysterese',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(428,NULL,'K_Bypass_Ein_Aus','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(429,'C_Byp_Name','K_Bypass_Name','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(430,'C_Byp_Analog_PCB','K_Bypass_Analogausgang_Modul','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(431,'C_Byp_Analog_Channel','K_Bypass_Analogausgang_Kanal','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(432,'C_Byp_Analog_Min_Volt','K_Bypass_Analogausgang_Min_V','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(433,'C_Byp_Analog_Max_Volt','K_Bypass_Analogausgang_Max_V','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(434,NULL,'A_Oeffnung_Min',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(435,NULL,'A_Oeffnung_Max',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(436,'C_Byp_Dir_On_Off','K_Bypass_Windrichtung_Ein_Aus','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(437,'V_Wind_Dir_From','A_Oeffnung_Windrichtung_ab',NULL,'Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(438,'V_Wind_Dir_Till','A_Oeffnung_Windrichtung_bis',NULL,'Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(439,'V_Wind_Dir_Range','A_Oeffnung_Windrichtung_Bereich',NULL,'Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(440,'C_Byp_Spd_On_Off','K_Bypass_Windgeschwindigkeit_Ein_Aus','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(441,'V_Wind_Spd_From','A_Oeffnung_Windgeschwindigkeit_ab',NULL,'Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(442,'V_Wind_Spd_Till','A_Oeffnung_Windgeschwindigkeit_bis',NULL,'Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(443,'C_Byp_VA_On_Off','K_Bypass_Luftleistung_Ein_Aus','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(444,'V_Byp_VA_From','A_Oeffnung_Luftleistung_ab',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(445,'V_Byp_VA_Till','A_Oeffnung_Luftleistung_bis',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(446,'C_Byp_Relais_On_Off','K_Bypass_Relais_Ein_Aus','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(447,'C_Byp_Relais_Name','K_Bypass_Relais_Name','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(448,'C_Byp_Relais_PCB','K_Bypass_Relais_Ausgang_Modul','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(449,'C_Byp_Relais_Channel','K_Bypass_Relais_Ausgang_Kanal','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(450,'C_Byp_Relais_Inactiv_Status','K_Bypass_Relais_Ausgang_Ruhezustand','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(451,'C_Byp_Relais_Hyst','K_Bypass_Relais_Hysterese','Bypass','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(452,'V_Byp_Relais_From','A_Bypass_Relais_Oeffnung_ab',NULL,'Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(453,'C_Sensors_On_Off','K_Sensoren_Ein_Aus','','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(454,'C_Temp_Waste_PCB','K_T_Roh_Fuehler_Modul','T_Rohr','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(455,'C_Temp_Waste_Channel','K_T_Roh_Fuehler_Kanal','T_Rohr','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(456,'C_Temp_Waste_Offset','K_T_Roh_Fuehler_Abgleich','T_Rohr','Luftwaescher_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(457,'C_Temp_Clean_PCB','K_T_Rein_Fuehler_Modul','T_Rein','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(458,'C_Temp_Clean_Channel','K_T_Rein_Fuehler_Kanal','T_Rein','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(459,'C_Temp_Clean_Offset','K_T_Rein_Fuehler_Abgleich','T_Rein','Luftwaescher_Konfig_Daten',NULL,'signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(460,'C_PH_PCB','K_PH_Fuehler_Modul','PH','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(461,'C_PH_Channel','K_PH_Fuehler_Kanal','PH','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(462,'C_PH_Min_V','K_PH_Min_V','PH','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(463,'C_PH_Max_V','K_PH_Max_V','PH','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(464,'C_PH_Min_Val','K_PH_Min_Wert','PH','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(465,'C_PH_Max_Val','K_PH_Max_Wert','PH','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(466,NULL,'K_PH_Alarm_Modus','PH','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(467,'C_Cond_PCB','K_Leit_Fuehler_Modul','Leit','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(468,'C_Cond_Channel','K_Leit_Fuehler_Kanal','Leit','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(469,'C_Cond_Min_V','K_Leit_Min_V','Leit','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(470,'C_Cond_Max_V','K_Leit_Max_V','Leit','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(471,'C_Cond_Min_Val','K_Leit_Min_Wert','Leit','Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(472,'C_Cond_Max_Val','K_Leit_Max_Wert','Leit','Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(473,NULL,'K_Leit_Alarm_Modus','Leit','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(474,NULL,'K_Luft_Druck_Fuehler_Modul','Luftdruck','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(475,NULL,'K_Luft_Druck_Fuehler_Kanal','Luftdruck','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(476,NULL,'K_Luft_Druck_Min_V','Luftdruck','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(477,NULL,'K_Luft_Druck_Max_V','Luftdruck','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(478,NULL,'K_Luft_Druck_Min_Wert','Luftdruck','Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(479,NULL,'K_Luft_Druck_Max_Wert','Luftdruck','Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(480,'C_Fresh_Press_PCB','K_Zulauf_Druck_Fuehler_Modul','Zulauf','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(481,'C_Fresh_Press_Channel','K_Zulauf_Druck_Fuehler_Kanal','Zulauf','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(482,'C_Fresh_Press_Min_V','K_Zulauf_Druck_Min_V','Zulauf','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(483,'C_Fresh_Press_Max_V','K_Zulauf_Druck_Max_V','Zulauf','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(484,'C_Fresh_Press_Min_Val','K_Zulauf_Druck_Min_Wert','Zulauf','Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(485,'C_Fresh_Press_Max_Val','K_Zulauf_Druck_Max_Wert','Zulauf','Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(486,NULL,'K_Zulauf_Impuls_Modul','Zulauf','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(487,NULL,'K_Zulauf_Impuls_Kanal','Zulauf','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(488,'C_Pump_Press_PCB','K_Pumpe_Druck_Fuehler_Modul','Pumpendruck','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(489,'C_Pump_Press_Channel','K_Pumpe_Druck_Fuehler_Kanal','Pumpendruck','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(490,'C_Pump_Press_Min_V','K_Pumpe_Druck_Min_V','Pumpendruck','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(491,'C_Pump_Press_Max_V','K_Pumpe_Druck_Max_V','Pumpendruck','Luftwaescher_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(492,'C_Pump_Press_Min_Val','K_Pumpe_Druck_Min_Wert','Pumpendruck','Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(493,'C_Pump_Press_Max_Val','K_Pumpe_Druck_Max_Wert','Pumpendruck','Luftwaescher_Konfig_Daten',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(494,'C_BM_On_Off','K_Antrieb_Ein_Aus','Antrieb','Stellantrieb_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(495,NULL,'K_Antrieb_Bezeichnung','Antrieb','Stellantrieb_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(496,NULL,'K_Antrieb_Name','Antrieb','Stellantrieb_Konfig_Daten',NULL,'char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(497,'C_BM_Room','K_Antrieb_Stallzuweisung','Antrieb','Stellantrieb_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(498,NULL,'K_Antrieb_Lueftergruppe','Antrieb','Stellantrieb_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(499,NULL,'K_Antrieb_Lueftergruppe_Stufe','Antrieb','Stellantrieb_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(500,NULL,'K_Antrieb_Modul','Antrieb','Stellantrieb_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(501,'C_BM_Display_Dir','K_Antrieb_Anzeige_Darstellung','Antrieb','Stellantrieb_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(502,'C_BM_Like_Motor','K_Antrieb_Verhalten','Antrieb','Stellantrieb_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(503,'C_BM_Moving_Dir','K_Antrieb_Laufrichtung','Antrieb','Stellantrieb_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(504,'C_BM_Min_Pos','K_Antrieb_alt_min','Antrieb','Stellantrieb_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(505,'C_BM_Max_Pos','K_Antrieb_alt_max','Antrieb','Stellantrieb_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(506,'C_BM_Startup','K_Antrieb_Inbetriebnahme','Antrieb','Stellantrieb_Konfig_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(507,NULL,'etzwerk_Knoten_Aktiv',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(508,NULL,'etzwerk_Knoten_Typ',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(509,NULL,'etzwerk_Knoten_Anforderung',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(510,NULL,'etzwerk_Knoten_Abfrage_State',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(511,NULL,'etzwerk_Knoten_Error',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(512,NULL,'etzwerk_Knoten_Error_Count',NULL,'etzwerk_Slave',NULL,'unsigned short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(513,NULL,'etzwerk_Knoten_Retry',NULL,'etzwerk_Slave',NULL,'unsigned short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(514,NULL,'IO_Modul_Anin',NULL,'etzwerk_Slave',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'IO_MODUL_ANIN_ANZ'),(515,NULL,'IO_Modul_Anin_Buffer',NULL,'etzwerk_Slave',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'IO_MODUL_ANIN_ANZ'),(516,NULL,'IO_Modul_Zin',NULL,'etzwerk_Slave',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'IO_MODUL_ZIN_ANZ'),(517,NULL,'IO_Modul_Revision',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(518,NULL,'IO_Modul_Digout',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(519,NULL,'IO_Modul_Anout',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'IO_MODUL_ANOUT_ANZ'),(520,NULL,'IO_Modul_Anout_Buffer',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(521,NULL,'IO_Modul_PHA_L1',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(522,NULL,'IO_Modul_PHA_L2',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(523,NULL,'IO_Modul_Messmode',NULL,'etzwerk_Slave',NULL,'unsigned short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(524,NULL,'Bedien_Modul_Stall_Nummer',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(525,NULL,'Bedien_Modul_Masken_Nummer',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(526,NULL,'Bedien_Modul_Regler_Tag',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(527,NULL,'Slave_Tableau_Adresse',NULL,'etzwerk_Slave',NULL,'unsigned long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(528,NULL,'Slave_Tableau_Byteanzahl',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(529,NULL,'Antrieb_Anzeige_Darstellung',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(530,NULL,'Antrieb_zugeteilter_Stall',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(531,NULL,'Antrieb_Verhalten',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(532,NULL,'Antrieb_Laufrichtung',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(533,NULL,'Antrieb_Status',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(534,NULL,'IO_Modul_Digout2',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(535,NULL,'IO_Modul_DigIn',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'FU_MODUL_DIN_ANZ'),(536,NULL,'eeprom_control',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(537,NULL,'eeprom_adresse',NULL,'etzwerk_Slave',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(538,NULL,'eeprom_adresse_r',NULL,'etzwerk_Slave',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(539,NULL,'eeprom_wert',NULL,'etzwerk_Slave',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(540,NULL,'Uebertragungs_Counter',NULL,'etzwerk_Slave',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(541,'L_Outside_Temp','P_Aussen_Temperatur',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(542,'L_Alarm_Outside_Broke','P_Alarm_Aussenfuehler_Bruch',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(543,'L_Alarm_Outside_','P_Alarm_Aussenfuehler_Kurzschluss',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(544,'L_Outside_Rel_Humidity','P_Aussen_Feuchte',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(545,'L_Outside_Abs_Humidity','P_Gramm_Pro_Kubikmeter',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(546,'L_Outside_Wind_Dir','P_Aussen_Windrichtung',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(547,NULL,'P_Aussen_Windrichtung_Himmel',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(548,'L_Outside_Wind_Spd','P_Aussen_Windgeschwindigkeit',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(549,NULL,'P_Aussen_Windrichtung_Buffer',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(550,NULL,'P_Aussen_Windgeschwindigkeit_Buffer',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(551,NULL,'P_Sonne_Sued',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(552,NULL,'P_Sonne_Ost',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(553,NULL,'P_Sonne_West',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(554,NULL,'P_Licht_Lux',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(555,NULL,'P_Regen',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(556,'L_Alarm_Sum','Summen_Alarm',NULL,'Allgemein_Live_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(557,'L_Alarm_Delay','Alarm_Zeitverzoegerung',NULL,'Allgemein_Live_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(558,'L_Heating_Sum','Summen_Heizung',NULL,'Allgemein_Live_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(559,NULL,'Alarmfeld_neu',NULL,'Allgemein_Live_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'ALARMFELD_ANZ'),(560,NULL,'Alarmfeld_alt',NULL,'Allgemein_Live_Daten',NULL,'unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'ALARMFELD_ANZ'),(561,NULL,'P_Wasser_Abtaster_sec',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WASSERZAEHLER_ANZAHL'),(562,NULL,'P_Wasser_Speicher',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WASSERZAEHLER_ANZAHL:366'),(563,NULL,'P_Wasser_Alarm',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(564,NULL,'P_Wasser_Alarm_Tag',NULL,'Allgemein_Live_Daten','rwx-r-xr-x','unsigned short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(565,NULL,'USB_Free_Space_Prozent',NULL,'Allgemein_Live_Daten',NULL,'unsigned int',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(566,NULL,'USB_Total_Space',NULL,'Allgemein_Live_Daten',NULL,'long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(567,NULL,'USB_Free_Space',NULL,'Allgemein_Live_Daten',NULL,'long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(568,'L_Order_Temp','P_Temperatur_Sollwert',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(569,'L_Inside_Temp','P_Temperatur_Istwert',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(570,'L_Humidity','P_Feuchte_Istwert',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(571,'L_Pollution','P_Schadstoff_Istwert',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(572,NULL,'P_THI_Istwert',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(573,'L_Order_Air_Min','P_Luft_Min_Sollwert',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(574,'L_Order_Air_Max','P_Luft_Max_Sollwert',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(575,'L_Air_Act','P_Luft_Akt',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(576,'L_Animal_Percent','P_Belegung_Prozent_Akt',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(577,'L_Animal_Kilo_Act','P_Belegung_Kilo_Akt',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(578,'L_Animal_Request','P_Belegung_Anforderung_Akt',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(579,'L_Corr_Max_On_Off','P_Begrenzungsminderung_Status',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(580,'L_Corr_Max_Val','P_Begrenzungsminderung_Wert',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(581,'L_Corr_Humidity_Val','P_Feuchtezugabe_Wert',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(582,'L_Corr_Pollution_Val','P_Schadstoffzugabe_Wert',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(583,'L_Corr_Temp_On_Off','P_Absenkautomatik_Status',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(584,NULL,'P_Absenkautomatik_Zugabe_Begrenzung',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(585,'L_Corr_Temp_Act','P_Absenkautomatik_Zugabe_Akt',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(586,NULL,'P_Absenkautomatik_Zugabe_Max',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(587,'L_Corr_Temp_Rest_Min','P_Absenkautomatik_Rueckstellung_Restdauer_Minuten',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(588,NULL,'P_Absenkautomatik_Delay_Max',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(589,NULL,'P_Absenkautomatik_Delay_start_Max',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(590,NULL,'P_Absenkautomatik_Delay_Time',NULL,'Live_Daten','rwx-r-xr-x','long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(591,'L_Heating_On_Off','P_Heizung_Status',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(592,'L_Heating_Diff','P_Heizung_Versatz',NULL,'Live_Daten','rwx-r-xr-x','signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(593,'L_Aux_Act','P_Regler_Analog_Akt',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'REGLER_ANZAHL'),(594,'L_Alarm_Upper_Act','P_Alarm_Obergrenze_Akt',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(595,'L_Alarm_Lower_Act','P_Alarm_Untergrenze_Akt',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(596,'L_Alarm_Upper','P_Alarm_Uebertemperatur',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(597,'L_Alarm_Lower','P_Alarm_Untertemperatur',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(598,'L_Alarm_Broke','P_Alarm_Fuehlerbruch',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(599,'L_Alarm_','P_Alarm_Fuehlerkurzschluss',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(600,NULL,'P_Alarm_Feucht',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(601,NULL,'P_Alarm_Trocken',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(602,NULL,'P_Alarm_Schadstoff_Hoch',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(603,NULL,'P_Alarm_Schadstoff_Niedrig',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(604,'L_Sin','P_Tagesverlauf_Soll',NULL,'Live_Daten','rwx-r-xr-x','signed char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(605,'L_Alarm_ASS_Broke','P_Alarm_LMS_Fuehlerbruch',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(606,'L_Alarm_ASS_','P_Alarm_LMS_Fuehlerkurzschluss',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(607,'L_Alarm','P_Alarm_Summe_Stall',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(608,'L_Actual_Day','P_Programme_Akt_Tag',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(609,'L_Optivent_Allowed','P_Optivent_Erlaubt',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(610,NULL,'P_Optivent_LL_Maximal',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(611,NULL,'P_Optivent_LL_Eigentlich',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(612,'L_Optivent_Pos','P_Optivent_Stellung',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(613,'L_Air_Vol_Pos','P_Luftmenge_Stellung',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(614,'L_Flep_Pos','P_Stellung',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(615,'L_Air_Vol_Percent','P_Luftmenge_Prozent',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(616,'L_Air_Speed','P_Geschwindigkeit_Akt',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(617,NULL,'P_Geschwindigkeit_Buffer',NULL,'Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(618,NULL,'P_LMS_Absenkung_Akt',NULL,'Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(619,NULL,'P_PID_p_gain',NULL,'Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(620,NULL,'P_PID_i_gain',NULL,'Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(621,NULL,'P_PID_d_gain',NULL,'Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(622,NULL,'P_PID_setpt',NULL,'Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(623,NULL,'P_PID_min',NULL,'Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(624,NULL,'P_PID_max',NULL,'Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(625,NULL,'P_PID_integral',NULL,'Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(626,NULL,'P_PID_last_error',NULL,'Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(627,NULL,'P_PID_last_output',NULL,'Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(628,NULL,'P_PID_this_target',NULL,'Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(629,NULL,'P_PID_next_target',NULL,'Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(630,NULL,'P_PID_rms_error',NULL,'Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(631,NULL,'P_Luftleistung',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(632,NULL,'P_Luftleistung_Buffer',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(633,'L_Fan_Speed_Act','P_Drehzahl',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(634,'L_Fan_Step2_Act','P_Stufe2_Aktiv',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(635,'L_Fan_Step3_Act','P_Stufe3_Aktiv',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(636,'L_Fan_Step4_Act','P_Stufe4_Aktiv',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(637,'L_Fan_Free2_Act','P_Stufe2_Blockierschutz_Restdauer',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(638,'L_Fan_Free3_Act','P_Stufe3_Blockierschutz_Restdauer',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(639,'L_Fan_Free4_Act','P_Stufe4_Blockierschutz_Restdauer',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(640,'L_Fan_Step1_Alarm','P_Stufe1_Alarm',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(641,'L_Fan_Step2_Alarm','P_Stufe2_Alarm',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(642,'L_Fan_Step3_Alarm','P_Stufe3_Alarm',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(643,'L_Fan_Step4_Alarm','P_Stufe4_Alarm',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(644,NULL,'P_Summen_Alarm',NULL,'Luefter_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(645,NULL,'P_PID_p_gain',NULL,'Luefter_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(646,NULL,'P_PID_i_gain',NULL,'Luefter_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(647,NULL,'P_PID_d_gain',NULL,'Luefter_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(648,NULL,'P_PID_setpt',NULL,'Luefter_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(649,NULL,'P_PID_min',NULL,'Luefter_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(650,NULL,'P_PID_max',NULL,'Luefter_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(651,NULL,'P_PID_integral',NULL,'Luefter_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(652,NULL,'P_PID_last_error',NULL,'Luefter_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(653,NULL,'P_PID_last_output',NULL,'Luefter_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(654,NULL,'P_PID_this_target',NULL,'Luefter_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(655,NULL,'P_PID_next_target',NULL,'Luefter_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(656,NULL,'P_PID_rms_error',NULL,'Luefter_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(657,'L_Air_Press','P_DruckLuft',NULL,'Luefter_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(658,'L_Airvolume','P_Volumenstrom',NULL,'Luefter_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(659,NULL,'P_Luftleistung',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(660,'L_EC_Pos_Act','P_Klappe_Oeffnung',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(661,NULL,'P_Oeffnung_Min',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(662,NULL,'P_Oeffnung_Max',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(663,'L_EC_Temp_On_Off','P_Regelung_Temperatur',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(664,'L_EC_Air_On_Off','P_Regelung_Luftleistung',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(665,'L_EC_Fan_On_Off','P_Zuluefter_Aktiv',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(666,'L_EC_Fan_Speed','P_Zuluefter_Drehzahl',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(667,'L_EC_Fan_Press','P_Zuluefter_Druck',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(668,NULL,'P_Betriebssec_Waschen',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(669,NULL,'P_Startzeit_Betriebssec',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(670,NULL,'P_Sekunden_Puls_Pause',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(671,NULL,'P_Startzeit_Puls_Pause',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(672,NULL,'P_Frostschutz_Waschen',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(673,NULL,'P_PID_p_gain',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(674,NULL,'P_PID_i_gain',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(675,NULL,'P_PID_d_gain',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(676,NULL,'P_PID_setpt',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(677,NULL,'P_PID_min',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(678,NULL,'P_PID_max',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(679,NULL,'P_PID_integral',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(680,NULL,'P_PID_last_error',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(681,NULL,'P_PID_last_output',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(682,NULL,'P_PID_this_target',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(683,NULL,'P_PID_next_target',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(684,NULL,'P_PID_rms_error',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','double',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(685,'L_EC_Wash_Bot','P_Waschen_Unten',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(686,'L_EC_Wash_Top','P_Waschen_Oben',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(687,NULL,'P_Windvektor',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(688,NULL,'P_Windboe',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(689,NULL,'P_Wind_Aenderung_Akt',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(690,NULL,'P_AT_Aenderung_Akt',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(691,NULL,'P_WindUndRegen_Aenderung_Akt',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(692,NULL,'P_Wetter_Aenderung_Akt',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(693,NULL,'P_Wetter_Max_Akt',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(694,NULL,'P_Puls_Pause_Akt',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(695,NULL,'P_Wind_Aktiv',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(696,NULL,'P_AT_Aktiv',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(697,NULL,'P_WindUndRegen_Aktiv',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(698,NULL,'P_Sturm_Aktiv',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(699,NULL,'P_Wetter_Aktiv',NULL,'Waermetauscher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(700,'L_Switch_On_Off','P_Schalt_Ausgang_Status',NULL,'Schaltausgang_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,NULL,NULL),(701,NULL,'P_Schalt_Ausgang_Schaltzeit_Sekunden',NULL,'Schaltausgang_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(702,NULL,'P_Schalt_Ausgang_Schaltzeit_Minuten',NULL,'Schaltausgang_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(703,NULL,'P_Schalt_Ausgang_Schaltzeit_Stunden',NULL,'Schaltausgang_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(704,NULL,'P_Schalt_Ausgang_Schaltzeit_Tag',NULL,'Schaltausgang_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(705,'L_Switch_Temp_Act','P_Schalt_Fuehl_Istwert',NULL,'Schaltausgang_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(706,'L_Switch_Activ','P_Temperatur_Aktiv',NULL,'Schaltausgang_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(707,NULL,'P_Zeit_Aktiv',NULL,'Schaltausgang_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(708,NULL,'P_Schalt_Aktiv',NULL,'Schaltausgang_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(709,'L_Request','P_Anforderung',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(710,NULL,'P_Drehzahl',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(711,NULL,'P_Stufe2_Aktiv',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(712,NULL,'P_Stufe3_Aktiv',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(713,NULL,'P_Stufe4_Aktiv',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(714,'L_Mud_Activ','P_Schlammpumpe_Aktiv',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(715,'L_Byp_Pos','P_Bypass_Oeffung',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(716,'L_Byp_Relais','P_Bypassrelais_Aktiv',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(717,'L_Air_Press','P_DruckLuft',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(718,'L_Fresh_Press','P_DruckWasser',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(719,'L_Pump_Press','P_DruckPumpe',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(720,'L_Airvolume','P_Volumenstrom',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(721,NULL,'P_Betriebssec_Pumpe',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(722,NULL,'P_Startzeit_Betriebssec_Pumpe',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(723,'L_Pump_Hours','P_Betriebsstd_Pumpe',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(724,NULL,'P_Betriebssec_Schlamm',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(725,NULL,'P_Startzeit_Betriebssec_Schlamm',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(726,'L_Mud_Hours','P_Betriebsstd_Schlamm',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(727,'L__Stdby','P_Intervall_Stdby',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(728,'L_Cond','P_Leitwert',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(729,'L_PH','P_PhWert',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(730,'L_Temp_Clean','P_Rohgastemp',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(731,'L_Temp_Waste','P_Reingastemp',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(732,'L_Alarm_Washing','P_Alarm',NULL,'Luftwaescher_Live_Daten','rwx-r-xr-x','unsigned char',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(733,NULL,'Anlage_Allgemein_Konfig_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(734,NULL,'Geraet_Allgemein_Konfig_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(735,NULL,'Stall_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'STALL_ANZAHL'),(736,NULL,'Stall_Konfig_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'STALL_ANZAHL'),(737,NULL,'Lueftergruppe_Konfig_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'LUEFTERGRUPPE_ANZAHL'),(738,NULL,'Waermetauscher_Konfig_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WAERMETAUSCHER_ANZAHL'),(739,NULL,'Luftwaescher_Konfig_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'LUFTWAESCHER_ANZAHL'),(740,NULL,'Schaltausgang_Konfig_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'SCHALTAUSGANG_ANZAHL'),(741,NULL,'Stellantrieb_Konfig_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'STELLANTRIEB_ANZAHL'),(742,NULL,'Allgemein_Live_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(743,NULL,'Luefter_Live_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'LUEFTERGRUPPE_ANZAHL'),(744,NULL,'Live_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'STALL_ANZAHL'),(745,NULL,'etzwerk_Slave',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'NETZWERK_SLAVE_ANZAHL_MAX'),(746,NULL,'Modbus_Slave',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'NETZWERK_SLAVE_ANZAHL_MAX'),(747,NULL,'Waermetauscher_Live_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'WAERMETAUSCHER_ANZAHL'),(748,NULL,'Schaltausgang_Live_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'SCHALTAUSGANG_ANZAHL'),(749,NULL,'Luftwaescher_Live_Daten',NULL,'Smh',NULL,'struct',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'LUFTWAESCHER_ANZAHL'),(750,NULL,'Uhr_Stunden',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(751,NULL,'Uhr_Minuten',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(752,NULL,'Uhr_Sekunden',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(753,NULL,'Uhr_Tag',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(754,NULL,'Uhr_Monat',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(755,NULL,'Uhr_Jahr',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(756,NULL,'Uhr_Wochentag',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(757,NULL,'Uhr_Wochentag_berechnet',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(758,NULL,'Uhr_Jahrestag_berechnet',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(759,NULL,'Time_Stamp',NULL,'Smh',NULL,'long',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(760,NULL,'Maskennummer',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(761,NULL,'Get_Eingabe_Werte',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(762,NULL,'Pid_berechnet',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(763,NULL,'Waermetauscher',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(764,NULL,'etzwerk_Modus',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(765,NULL,'Berechnungs_State',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(766,NULL,'Stellantrieb',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(767,NULL,'Lueftergruppe',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(768,NULL,'Tag_Nummer',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(769,NULL,'Stall_Nummer',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(770,NULL,'Sprache',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(771,NULL,'etzwerkteilnehmer',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(772,NULL,'Wasserzaehler',NULL,'Smh',NULL,'short',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `data_value` (
  ...
  `enumeration_value` varchar(45) DEFAULT NULL,
  `enumeration_id` int(11) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `sensitive_data_demo` VALUES (1,'1',' ≠ó$\ËòvÛ¢]L8®\\˙í\œ]iˆsíó_%m\0VRX');
...
INSERT INTO `translation` VALUES (1,'email','E-Mail','e-mail','e-mail','NULL','NULL','NULL'),(2,'login','Anmeldung','login','missing','NULL','NULL','NULL'),(3,'password','Passwort','password','missing','NULL','NULL','NULL'),(4,'language','Sprache','language','missing','NULL','NULL','NULL'),(5,'overview','√úbersicht','overview','missing','NULL','NULL','NULL'),(6,'logged_as','Eingeloggt als','logged in as','missing','NULL','NULL','NULL'),(7,'last_login','Letzer login','last login','missing','NULL','NULL','NULL'),(8,'reset_filter','Filter zur√ºcksetzen','reset filter','missing','Durch die Schaltfl√§che Filter zur√ºcksetzen werden alle Kunden und Anlagen angezeigt','NULL','NULL'),(9,'german','Deutsch','German','missing','NULL','NULL','NULL'),(10,'english','Englisch','English','missing','NULL','NULL','NULL'),(11,'french','Franz√∂sisch','French','missing','NULL','NULL','NULL'),(12,'password_to_short','Passwort zu kurtz','password to short','missing','NULL','NULL','NULL'),(13,'wrong_password','Passwort passt nicht zur Email','Password doesnt match email','missing','NULL','NULL','NULL'),(14,'wrong_email','Email existiert nicht','Email doesnt exist','missing','NULL','NULL','NULL'),(15,'overview','√úbersicht','Overview','missing','NULL','NULL','NULL'),(16,'client_overview','Kunden √úbersicht','client overview','missing','NULL','NULL','NULL'),(17,'client_create','Kunde anlegen','create client','missing','NULL','NULL','NULL'),(18,'system_overview','Anlagen √úbersicht','system overview','missing','NULL','NULL','NULL'),(19,'system_create','Anlage anlegen','create system','missing','NULL','NULL','NULL'),(20,'client','Kunde','client','missing','NULL','NULL','NULL'),(21,'client_id','Kunden Nr.','client id','missing','NULL','NULL','NULL'),(22,'firstname','Vorname','firstname','missing','NULL','NULL','NULL'),(23,'lastname','Nachname','lastname','missing','NULL','NULL','NULL'),(24,'street','Stra√üe','street','missing','NULL','NULL','NULL'),(25,'postcode','PLZ','postcode','missing','NULL','NULL','NULL'),(26,'town','Stadt','town','missing','NULL','NULL','NULL'),(27,'number','Nummer','number','missing','NULL','NULL','NULL'),(28,'client_search','suchen','search','missing','suche nach Kunde, Kunden Nr, Vorname ...','search for client, client id, firstname ...','missing'),(29,'system_search','suchen','search','missing','suche nach Anlage, Ip, addresse ...','search for system, ip, adresse ...','missing'),(30,'reset_filter','Filter zur√ºcksetzen','reset filter','missing','NULL','NULL','NULL'),(31,'system_id','Anlagen Nr.','system id','missing','NULL','NULL','NULL'),(32,'system_ip','Anlagen Ip','system ip','missing','NULL','NULL','NULL'),(33,'name','Name','name','missing','NULL','NULL','NULL'),(34,'system','Anlage','system','missing','NULL','NULL','NULL'),(35,'password2','Passwort wiederholen','repeat password','missing','NULL','NULL','NULL'),(36,'super_client','√úbergeordneter Benutzer','superclient','missing','NULL','NULL','NULL'),(37,'street_number','Stra√üen Nr.','street number','missing','NULL','NULL','NULL'),(38,'region','Region','region','missing','NULL','NULL','NULL'),(39,'logout_timer','Auslogzeit','logout timer','missing','NULL','NULL','NULL'),(40,'logo','Logo','logo','missing','NULL','NULL','NULL'),(41,'description_intern','Interne Beschreibeung','description(intern)','missing','NULL','NULL','NULL'),(42,'description_extern','Externe Beschreibung','description(extern)','missing','NULL','NULL','NULL'),(43,'create','Anlegen','create','missing','NULL','NULL','NULL'),(44,'change','√Ñndern','change','missing','NULL','NULL','NULL'),(45,'delete','L√∂schen','delete','missing','NULL','NULL','NULL'),(46,'delete_confirm','M√∂chten sie wirklich l√∂schen?','are you sure to delete?','missing','NULL','NULL','NULL'),(47,'change_password','Passwort √§ndern','change password','missing','NULL','NULL','NULL'),(48,'old_password','Altes Passwort','old password','missing','NULL','NULL','NULL'),(49,'ip_address','Ip Adresse','ip address','missing','NULL','NULL','NULL'),(50,'client_client_id','√úbergeordenter Benutzer','superclient','missing','NULL','NULL','NULL'),(51,'status','Status','status','missing','NULL','NULL','NULL'),(52,'on_top_10m','Mit aufsatz 10m','on top 10m','missing','NULL','NULL','NULL'),(53,'washing','W√§scher','washing','missing','NULL','NULL','NULL'),(54,'dryer','Trockner','dryer','missing','NULL','NULL','NULL'),(55,'control','Steuerung','control','missing','NULL','NULL','NULL'),(56,'switch_cabinet','Schaltschrank','switch cabinet','missing','NULL','NULL','NULL'),(57,'display','Display Nr.','display','missing','NULL','NULL','NULL'),(58,'qt','QT','qt','missing','NULL','NULL','NULL'),(59,'image','Images','image','missing','NULL','NULL','NULL'),(60,'link','Link','link','missing','NULL','NULL','NULL'),(61,'password_hash','Passwort','password','missing','NULL','NULL','NULL'),(62,'password_hash2','Passwort wiederholen','repeate password','missing','NULL','NULL','NULL'),(63,'components','Komponenetn','components','missing','NULL','NULL','NULL'),(64,'street_nr','Stra√üen Nr.','street number','missing','NULL','NULL','NULL'),(65,'captcha','Captcha','captcha','captcha',NULL,NULL,NULL),(66,'de','Deutsch','German','missing',NULL,NULL,NULL),(67,'fr','Franz√∂sisch','French','missing',NULL,NULL,NULL),(68,'en','Englisch','English','missing',NULL,NULL,NULL),(69,'fergot_password','Passwort vergessen?','fergot password?','missing',NULL,NULL,NULL),(70,'remember_me','Daten merken','remember me','missing',NULL,NULL,NULL),(71,'no_email','Keine Email','missing email','missing',NULL,NULL,NULL),(72,'no_password','Kein Passwort','missing password','missing',NULL,NULL,NULL),(73,'no_captcha_code','Kein Captcha','missing captcha','missing',NULL,NULL,NULL),(74,'wrong_captcha','Captcha stimmt nicht √ºberein','captcher doesnt match','missing',NULL,NULL,NULL),(75,'submit','Absenden','submit','missing',NULL,NULL,NULL),(76,'enter_username','Benutzername Eintragen','enter username','missing',NULL,NULL,NULL),(77,'enter_password','Password Eingeben','enter password','missing',NULL,NULL,NULL),(78,'enter_captcha','Captcha Eingeben','enter captcha','missing',NULL,NULL,NULL),(79,'logout','Ausloggen','logout','missing',NULL,NULL,NULL),(80,'id','id','id','id',NULL,NULL,NULL);
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2017-05-14 14:59:33',NULL),('diagnostics.include_raw','OFF','2017-05-14 14:59:33',NULL),('ps_thread_trx_info.max_length','65535','2017-05-14 14:59:33',NULL),('statement_performance_analyzer.limit','100','2017-05-14 14:59:33',NULL),('statement_performance_analyzer.view',NULL,'2017-05-14 14:59:33',NULL),('statement_truncate_len','64','2017-05-14 14:59:33',NULL);
...
-- Dump completed on 2017-12-01 11:56:10
